...
export const updateEmailAction = (value, isValid, errorMessage) => {
    return updateState(value, isValid, errorMessage, adminActionTypes.UPDATE_EMAIL);
};

export const updatePasswordAction = (value, isValid, errorMessage) => {
    return updateState(value, isValid, errorMessage, adminActionTypes.UPDATE_PASSWORD);
};
